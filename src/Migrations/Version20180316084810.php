 ...
 */
class Version20180316084810 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, is_captcha TINYINT(1) NOT NULL, `limit` INT NOT NULL, public TINYINT(1) NOT NULL, api TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE directory (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, last_update_ts DATETIME NOT NULL, INDEX IDX_467844DAA76ED395 (user_id), INDEX IDX_467844DA727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE element ADD CONSTRAINT FK_41405E39FE54D947 FOREIGN KEY (group_id) REFERENCES directory (id)');
        $this->addSql('ALTER TABLE token ADD CONSTRAINT FK_5F37A13BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE directory ADD CONSTRAINT FK_467844DAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
